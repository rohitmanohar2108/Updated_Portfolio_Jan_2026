...
const CodingProgress = () => {
  ...
  const difficulties = [
    ...
    { name: 'Medium', solved: 89, total: 438, color: 'hsl(45, 93%, 47%)', glowColor: 'rgba(234, 179, 8, 0.6)' },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div>
          <div className="flex justify-center">
            <div className="group border border-border rounded-lg p-6 bg-card hover:border-primary/50 transition-all duration-300 hover:shadow-lg sm:p-10 flex flex-col sm:flex-row items-center gap-8 sm:gap-12">
